...
API b8 input_was_key_down(keys key);
API b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

// mouse input
API b8 input_is_button_down(buttons button);
API b8 input_is_button_up(buttons button);
API b8 input_was_button_down(buttons button);
API b8 input_was_button_up(buttons button);
API void input_get_mouse_pos(i32* x, i32* y);
API void input_get_prev_mouse_pos(i32* x, i32* y);
