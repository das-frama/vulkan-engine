...
void vulkan_renderpass_create(vulkan_context* context,
    ...
    // Attachments. // TODO(frama): make this configurable.
    u32 attachment_description_count = 2;
    VkAttachmentDescription attachment_descriptions[attachment_description_count];
    
    // Color attachment.
    VkAttachmentDescription color_attachment;
    color_attachment.format = context->swapchain.image_format.format; // TODO(frama): configurable
    ...
    // TODO(frama): other attachment types (input, resolve, preserve).
    ...
    // Attachments use for multisapmpling color attachments.
    subpass.pResolveAttachments = 0;
    
    // Attachments not used in this supbass, but must be presereved for the next.
    subpass.preserveAttachmentCount = 0;
    subpass.pPreserveAttachments = 0;
    
    // Render pass dependencies: // TODO(frama): make this configurable
